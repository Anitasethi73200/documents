    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content active-trigger ps ps--active-y">
            <ul class="dash-navbar" style="display: block;">
                ...
                @can('manage-inbox')
                    <li class="dash-item dash-hasmenu {{ request()->is('inbox*') ? 'active' : '' }}">
                        <a class="dash-link" href="{{ route('share.index') }}">
                            <span class="dash-micon"><i class="ti ti-user"></i></span>
                            <span class="dash-mtext custom-weight">{{ __('Inbox') }}</span>
                        </a>
                    </li>
                @endcan
                @can('manage-user')
                ...
                @can('manage-document')
                    <li class="dash-item dash-hasmenu {{ request()->is('document*') ? 'active' : '' }}">
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li class="dash-item dash-hasmenu"><a class="dash-link" href="{{ route('document.index') }}">Search</a></li>
                ...
                @can('manage-file')
                    <li class="dash-item dash-hasmenu {{ request()->is('file*') ? 'active' : '' }}">
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li class="dash-item dash-hasmenu"><a class="dash-link" href="{{ route('file.sent') }}">Sent</a>
                            </li>
                            <li class="dash-item dash-hasmenu"><a class="dash-link" href="{{ route('file.index') }}">Search</a></li>
