            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="receipt_status" value="physical">Physical
                        </label>
                    </div>
                    <div class="form-group">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                {{ Form::date('dairy_date', null, ['class' => 'form-control', 'placeholder' => __('DairyDate')]) }}
                                @error('dairy_date')
                                    <span class="invalid-name" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="language" id="language" class="form-control">
                                    ...
                                    <option value="English"{{$receipt =='English' ? 'selected' : ''}}>English</option>
                                    <option value="odia" {{$receipt =='odia' ? 'selected' : ''}}>odia</option>
                                    <option value="Hindi" {{$receipt =='Hindi' ? 'selected' : ''}}>Hindi</option>
                                </select>
                                @error('language')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    {{ Form::label('department', __('Department/other:')), ['class' => 'form-label'] }}
                                    <select name="department" id="department" class="form-control">
                                        <option value="">Select Department</option>
                                        @foreach ($department as $departments)
                                            <option value="{{ $departments->id }}" @if ($receipt->department == $departments->id) selected @endif>
                                                {{ $departments->name }}
                                        @endforeach
                                    </select>
                                    @error('department')
